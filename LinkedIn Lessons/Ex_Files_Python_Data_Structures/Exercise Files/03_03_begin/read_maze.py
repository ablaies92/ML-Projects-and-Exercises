...
def read_maze(file_name):
    ...
    """
    # try/except is that we try to run code and return a print error statement if it fails
    try:
        # open the file, strip each line and test for rectangularness (line 17)
...
if __name__ == "__main__":
    ...
    maze_challenge = read_maze("mazes/challenge_maze.txt")
    for row in maze_challenge:
        print(row)
